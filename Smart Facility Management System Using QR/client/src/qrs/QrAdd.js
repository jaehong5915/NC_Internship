...
class Qradd extends Component {
    ...
    render() {
        ...
        const JcellList = ['자재코드','자재명','자재분류','자재등급','입고날짜', '이미지', 'QR코드', '수정', '삭제']; 
      ...
      return (
        <div>
            <h5><br/>
                <AiOutlineHome /> / QR코드관리/ 자재 QR코드 생성
            </h5><br/>
            <div className={classes.root}>
                ...
                <Card style={{width: '140px', height:'45px', backgroundColor:'gray', color:'white', textAlign:'center', justifyContent:'center'}}><h5>자재 상세 정보</h5></Card>
