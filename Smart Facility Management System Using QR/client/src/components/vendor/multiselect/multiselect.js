        ...
        Multiselect.prototype = {
            ...
            init: function() {
                ...
                if (!self.skipInitSort && typeof self.callbacks.sort == "function") {
                    ...
                    self.right.each(function(i, select) {
                        $(select).find("option").sort(self.callbacks.sort).appendTo(select)
                    })
                }
            ...
            events: function(actions) {
                ...
                self.right.closest("form").on("submit", function(e) {
                    self.left.children().prop("selected", !0);
                    self.right.children().prop("selected", !0)
                });
            ...
            undo: function(event) {
                ...
                if (last) {
                    ...
                    switch (last[0]) {
                        case "left":
                            self.moveToRight(last[1], event, !1, !0);
                            break;
                        case "right":
                            self.moveToLeft(last[1], event, !1, !0);
                            break
                    }
                }
            },
